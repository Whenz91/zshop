    ...
    <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
        <div class="p-4 sm:p-7">
            <div class="text-center">
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Regisztráció</h1>
            ...
            <div class="mt-5">
                ...
                <form>
                    <div class="grid gap-y-4">
                        ...
                        <!-- Form Group -->
                        <div>
                            <label for="password" class="block text-sm mb-2 dark:text-white">Jelszó</label>
                            <div class="relative">
                        ...
                        <!-- Form Group -->
                        <div>
                            <label for="confirm-password" class="block text-sm mb-2 dark:text-white">Jelszó ismét</label>
                            <div class="relative">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ms-3">
                                <label for="remember-me" class="text-sm dark:text-white">Elfogadom a <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="#">Felhasználói feltételeket</a></label>
                            </div>
                        </div>
                        <!-- End Checkbox -->

                        <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Regisztráció</button>
                    </div>
                </form>
                <!-- End Form -->
            </div>
