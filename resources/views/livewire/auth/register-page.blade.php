            ...
            <div class="mt-5">
                ...
                <form wire:submit.prevent="save">
                    <div class="grid gap-y-4">
                        <!-- Form Group -->
                        <div>
                            <label for="name" class="block text-sm mb-2 dark:text-white">Név</label>
                            <div class="relative">
                        ...
                        <!-- Form Group -->
                        <div>
                            <label for="password_confirmation" class="block text-sm mb-2 dark:text-white">Jelszó ismét</label>
                            <div class="relative">
