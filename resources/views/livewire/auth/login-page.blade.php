                ...
                <form>
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            ...
                            <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="{{ route('forgot') }}">Elfelejtetted a jelszavad?</a>
                            </div>
                            <div class="relative">
