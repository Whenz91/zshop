<div>
    ...
    <section class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Egyedülálló floráriumok és moha-képek a <span class="text-blue-600">Zoláriumtól</span></h1>
          <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Különlegess kézműves ajándékok a növények és elő lakásdekorációk kedvelőinek</p>
        ...
        <div class="relative ms-4">
          <img class="w-full rounded-md" src="https://images.unsplash.com/photo-1467241850596-6a0de48568da?q=80&w=700&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Hero Image">
    ...
    <!-- Start Featured Categories -->
     <section class="mt-24">
        <h2 class="block text-2xl font-bold text-gray-800 sm:text-3xl lg:text-5xl lg:leading-tight dark:text-white mb-10"><span class="text-blue-600">Népszerű</span> kategóriák</h2>
